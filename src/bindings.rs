...
pub const IR_VERSION_MAJOR: u32 = 3;
pub const IR_VERSION_MINOR: u32 = 0;
pub const IR_VERSION_PATCH: u32 = 6;
...
impl IRCompatibilityFlags {
    ...
    pub const ForceTextureArray: IRCompatibilityFlags = IRCompatibilityFlags(256);
}
...
pub enum IRIntersectionFunctionCompilationMode {
    ...
    IntersectionFunctionBufferFunction = 2,
}
#[repr(u32)]
#[non_exhaustive]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
pub struct metal_irconverter {
    ...
    pub IRRayTracingPipelineConfigurationCreate:
        unsafe extern "C" fn() -> *mut IRRayTracingPipelineConfiguration,
    pub IRRayTracingPipelineConfigurationDestroy:
        unsafe extern "C" fn(configuration: *mut IRRayTracingPipelineConfiguration),
    pub IRRayTracingPipelineConfigurationSetMaxAttributeSizeInBytes: unsafe extern "C" fn(
        configuration: *mut IRRayTracingPipelineConfiguration,
        maxAttributeSizeInBytes: u32,
    ),
    pub IRRayTracingPipelineConfigurationSetPipelineFlags: unsafe extern "C" fn(
        configuration: *mut IRRayTracingPipelineConfiguration,
        raytracingPipelineFlags: IRRaytracingPipelineFlags,
    ),
    pub IRRayTracingPipelineConfigurationSetIntrinsicMasks: unsafe extern "C" fn(
        configuration: *mut IRRayTracingPipelineConfiguration,
        chs: u64,
        miss: u64,
        anyHit: u64,
    ...
    pub IRRayTracingPipelineConfigurationSetMaxRecursiveDepth: unsafe extern "C" fn(
        configuration: *mut IRRayTracingPipelineConfiguration,
        maxRecursiveDepth: ::std::os::raw::c_int,
    ),
    pub IRRayTracingPipelineConfigurationSetRayGenerationCompilationMode: unsafe extern "C" fn(
        configuration: *mut IRRayTracingPipelineConfiguration,
        rayGenMode: IRRayGenerationCompilationMode,
    ),
    pub IRRayTracingPipelineConfigurationSetIntersectionFunctionCompilationMode:
        unsafe extern "C" fn(
            configuration: *mut IRRayTracingPipelineConfiguration,
            intersectionFunctionMode: IRIntersectionFunctionCompilationMode,
        ),
    pub IRRayTracingPipelineConfigurationEnableIntersectionFunctionGroups: unsafe extern "C" fn(
        configuration: *mut IRRayTracingPipelineConfiguration,
        enableIntersectionFunctionGroups: bool,
    ),
    pub IRRayTracingPipelineConfigurationEnableDirectStateAccess: unsafe extern "C" fn(
        configuration: *mut IRRayTracingPipelineConfiguration,
        enableDirectStateAccess: bool,
    ),
    pub IRCompilerSetRayTracingPipelineConfiguration: unsafe extern "C" fn(
        compiler: *mut IRCompiler,
        configuration: *const IRRayTracingPipelineConfiguration,
    ),
    ...
    pub IRCompilerSetSampleMask: unsafe extern "C" fn(compiler: *mut IRCompiler, sampleMask: u32),
    ...
    pub IRCompilerSetFunctionConstantResourceSpace:
        unsafe extern "C" fn(compiler: *mut IRCompiler, spaceValue: u32),
    pub IRCompilerSetFramebufferFetchResourceSpace:
        unsafe extern "C" fn(compiler: *mut IRCompiler, spaceValue: u32),
    ...
    pub IRVersionedRootSignatureDescriptorCopyJSONString:
        unsafe extern "C" fn(
            rootSignatureDescriptor: *const IRVersionedRootSignatureDescriptor,
        ) -> *const ::std::os::raw::c_char,
    ...
    pub IRVersionedRootSignatureDescriptorCreateFromBlob:
        unsafe extern "C" fn(
            blob: *const u8,
            blobSize: u32,
            error: *mut *mut IRError,
    ...
    pub IRInputLayoutDescriptor1CopyJSONString:
        unsafe extern "C" fn(
            inputLayoutDescriptor: *const IRInputLayoutDescriptor1,
        ) -> *const ::std::os::raw::c_char,
...
impl metal_irconverter {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let IRCompilerSetRayTracingPipelineArguments = __library
            ...
            .map(|sym| *sym)?;
        let IRRayTracingPipelineConfigurationCreate = __library
            .get(b"IRRayTracingPipelineConfigurationCreate\0")
            .map(|sym| *sym)?;
        let IRRayTracingPipelineConfigurationDestroy = __library
            .get(b"IRRayTracingPipelineConfigurationDestroy\0")
            .map(|sym| *sym)?;
        let IRRayTracingPipelineConfigurationSetMaxAttributeSizeInBytes = __library
            .get(b"IRRayTracingPipelineConfigurationSetMaxAttributeSizeInBytes\0")
            .map(|sym| *sym)?;
        let IRRayTracingPipelineConfigurationSetPipelineFlags = __library
            .get(b"IRRayTracingPipelineConfigurationSetPipelineFlags\0")
            .map(|sym| *sym)?;
        let IRRayTracingPipelineConfigurationSetIntrinsicMasks = __library
            .get(b"IRRayTracingPipelineConfigurationSetIntrinsicMasks\0")
            .map(|sym| *sym)?;
        let IRRayTracingPipelineConfigurationSetMaxRecursiveDepth = __library
            .get(b"IRRayTracingPipelineConfigurationSetMaxRecursiveDepth\0")
            .map(|sym| *sym)?;
        let IRRayTracingPipelineConfigurationSetRayGenerationCompilationMode = __library
            .get(b"IRRayTracingPipelineConfigurationSetRayGenerationCompilationMode\0")
            .map(|sym| *sym)?;
        let IRRayTracingPipelineConfigurationSetIntersectionFunctionCompilationMode = __library
            .get(b"IRRayTracingPipelineConfigurationSetIntersectionFunctionCompilationMode\0")
            .map(|sym| *sym)?;
        let IRRayTracingPipelineConfigurationEnableIntersectionFunctionGroups = __library
            .get(b"IRRayTracingPipelineConfigurationEnableIntersectionFunctionGroups\0")
            .map(|sym| *sym)?;
        let IRRayTracingPipelineConfigurationEnableDirectStateAccess = __library
            .get(b"IRRayTracingPipelineConfigurationEnableDirectStateAccess\0")
            .map(|sym| *sym)?;
        let IRCompilerSetRayTracingPipelineConfiguration = __library
            .get(b"IRCompilerSetRayTracingPipelineConfiguration\0")
            .map(|sym| *sym)?;
        ...
        let IRCompilerSetSampleMask = __library
            .get(b"IRCompilerSetSampleMask\0")
            .map(|sym| *sym)?;
        ...
        let IRCompilerSetMinimumDeploymentTarget = __library
            ...
            .map(|sym| *sym)?;
        let IRCompilerSetFunctionConstantResourceSpace = __library
            .get(b"IRCompilerSetFunctionConstantResourceSpace\0")
            .map(|sym| *sym)?;
        let IRCompilerSetFramebufferFetchResourceSpace = __library
            .get(b"IRCompilerSetFramebufferFetchResourceSpace\0")
            .map(|sym| *sym)?;
        ...
        let IRVersionedRootSignatureDescriptorCreateFromJSON = __library
            ...
            .map(|sym| *sym)?;
        let IRVersionedRootSignatureDescriptorCreateFromBlob = __library
            .get(b"IRVersionedRootSignatureDescriptorCreateFromBlob\0")
            .map(|sym| *sym)?;
        ...
        Ok(metal_irconverter {
            ...
            IRCompilerSetFramebufferFetchResourceSpace,
            ...
            IRVersionedRootSignatureDescriptorCreateFromBlob,
    ...
    #[doc = " Create a new instance of a ray tracing pipeline configuration.\n @return a newly-allocated IRRayTracingPipelineConfiguration instance.\n @note call `IRRayTracingPipelineConfigurationDestroy` to release the instance's memory."]
    pub unsafe fn IRRayTracingPipelineConfigurationCreate(
        &self,
    ) -> *mut IRRayTracingPipelineConfiguration {
        (self.IRRayTracingPipelineConfigurationCreate)()
    }
    #[doc = " Destroy an instance of a ray tracing pipeline configuration.\n @param configuration configuration object to destroy.\n @note allocate the instance by calling `IRRayTracingPipelineConfigurationCreate`."]
    pub unsafe fn IRRayTracingPipelineConfigurationDestroy(
        &self,
        configuration: *mut IRRayTracingPipelineConfiguration,
    ) {
        (self.IRRayTracingPipelineConfigurationDestroy)(configuration)
    }
    #[doc = " Set the maximum attribute size in bytes for a ray tracing pipeline configuration object.\n @param configuration configuration object to modify.\n @param maxAttributeSizeInBytes the maximum number of ray tracing attributes (in bytes) that a pipeline consisting of these shaders uses (defaults to 16)."]
    pub unsafe fn IRRayTracingPipelineConfigurationSetMaxAttributeSizeInBytes(
        &self,
        configuration: *mut IRRayTracingPipelineConfiguration,
        maxAttributeSizeInBytes: u32,
    ) {
        (self.IRRayTracingPipelineConfigurationSetMaxAttributeSizeInBytes)(
            configuration,
            maxAttributeSizeInBytes,
        )
    }
    #[doc = " Set ray tracing pipeline flags for a ray tracing pipeline configuration object.\n @param configuration configuration object to update.\n @param raytracingPipelineFlags flags the compiler specifies for the subsequent compiled ray tracing pipelines (defaults to `IRRaytracingPipelineFlagNone`)."]
    pub unsafe fn IRRayTracingPipelineConfigurationSetPipelineFlags(
        &self,
        configuration: *mut IRRayTracingPipelineConfiguration,
        raytracingPipelineFlags: IRRaytracingPipelineFlags,
    ) {
        (self.IRRayTracingPipelineConfigurationSetPipelineFlags)(
            configuration,
            raytracingPipelineFlags,
        )
    }
    #[doc = " Set the intrinsic masks to generate an optimized interface between ray tracing functions.\n Calling this function is optional, but when omitted, the compiler assumes a worst-case scenario, affecting runtime performance.\n After calling this function, all subsequent shaders compiled need to conform to the masks provided, otherwise undefined behavior occurs.\n Use function `IRObjectGatherRaytracingIntrinsics` to collect the intrinsic usage mask for all closest hit, any hit, intersection, and callable shaders in the pipeline to build.\n @param configuration configuration object to modify.\n @param chs bitwise OR mask of all closest hit shaders for a ray tracing pipeline your application builds using subsequent converted shaders (defaults to `IRIntrinsicMaskClosestHitAll`). The value must match across all functions of all types used in this RT pipeline.\n @param miss bitwise OR mask of all miss shaders for a ray tracing pipeline your application builds using subsequent converted shaders (defaults to `IRIntrinsicMaskMissShaderAll`). The value must match across all functions of all types used in this RT pipeline.\n @param anyHit bitwise OR mask of all any hit shaders for a ray tracing pipeline your application builds using subsequent converted shaders (defaults to `IRIntrinsicMaskAnyHitShaderAll`). The value must match across all functions of all types used in this RT pipeline.\n @param callableArgs bitwise OR mask of all callable shaders for a ray tracing pipeline your application builds using subsequent converted shaders (defaults to `IRIntrinsicMaskCallableShaderAll`). The value must match across all functions of all types used in this RT pipeline.\n @warning providing mask values other than the defaults or those returned by `IRObjectGatherRaytracingIntrinsics` may cause subsequent shader compilations to fail."]
    pub unsafe fn IRRayTracingPipelineConfigurationSetIntrinsicMasks(
        &self,
        configuration: *mut IRRayTracingPipelineConfiguration,
        chs: u64,
        miss: u64,
        ...
        (self.IRRayTracingPipelineConfigurationSetIntrinsicMasks)(
            configuration,
            chs,
            miss,
            anyHit,
    ...
    #[doc = " Specify the stop point for recursion when compiling shaders for a ray tracing pipeline.\n @param configuration configuration object to modify.\n @param maxRecursiveDepth stop point for recursion. Pass `IRRayTracingUnlimitedRecursionDepth` for no limit (default)."]
    pub unsafe fn IRRayTracingPipelineConfigurationSetMaxRecursiveDepth(
        &self,
        configuration: *mut IRRayTracingPipelineConfiguration,
        maxRecursiveDepth: ::std::os::raw::c_int,
    ) {
        (self.IRRayTracingPipelineConfigurationSetMaxRecursiveDepth)(
            configuration,
            maxRecursiveDepth,
        )
    }
    #[doc = " Set the compilation mode for ray generation functions.\n @param configuration configuration object to modify.\n @param rayGenMode compilation mode for ray generation functions."]
    pub unsafe fn IRRayTracingPipelineConfigurationSetRayGenerationCompilationMode(
        &self,
        configuration: *mut IRRayTracingPipelineConfiguration,
        rayGenMode: IRRayGenerationCompilationMode,
    ) {
        (self.IRRayTracingPipelineConfigurationSetRayGenerationCompilationMode)(
            configuration,
            rayGenMode,
        )
    }
    #[doc = " Set the compilation mode for ray tracing intersection functions.\n @param configuration configuration object to modify.\n @param intersectionFunctionMode compilation mode for intersection functions."]
    pub unsafe fn IRRayTracingPipelineConfigurationSetIntersectionFunctionCompilationMode(
        &self,
        configuration: *mut IRRayTracingPipelineConfiguration,
        intersectionFunctionMode: IRIntersectionFunctionCompilationMode,
    ) {
        (self.IRRayTracingPipelineConfigurationSetIntersectionFunctionCompilationMode)(
            configuration,
            intersectionFunctionMode,
        )
    }
    #[doc = " Enable the compiler to annotate converted shaders with function group information, potentially accelerating ray tracing function calling.\n @param configuration configuration object to modify.\n @param enableIntersectionFunctionGroups set to true to enable emitting annotations, false to disable it."]
    pub unsafe fn IRRayTracingPipelineConfigurationEnableIntersectionFunctionGroups(
        &self,
        configuration: *mut IRRayTracingPipelineConfiguration,
        enableIntersectionFunctionGroups: bool,
    ) {
        (self.IRRayTracingPipelineConfigurationEnableIntersectionFunctionGroups)(
            configuration,
            enableIntersectionFunctionGroups,
        )
    }
    #[doc = " Enable converted shaders to directly access ray intersection results from memory.\n @param configuration configuration object to modify.\n @param enableDirectStateAccess set to true to enable compiled shaders to directly fetch intersection result data from memory,\n false to access data via parameter passing.\n @note this feature requires the converted shader pipeline to run on macOS 15, iOS 18, or later."]
    pub unsafe fn IRRayTracingPipelineConfigurationEnableDirectStateAccess(
        &self,
        configuration: *mut IRRayTracingPipelineConfiguration,
        enableDirectStateAccess: bool,
    ) {
        (self.IRRayTracingPipelineConfigurationEnableDirectStateAccess)(
            configuration,
            enableDirectStateAccess,
        )
    }
    #[doc = " Set the ray tracing pipeline configuration preferences for a compiler.\n All subsequent shaders this compiler converts use this configuration.\n @param compiler compiler object to configure.\n @param configuration configuration to establish.\n @note the configuration should remain consistent across all shaders that form a single ray tracing pipeline, otherwise\n undefined behavior may occur."]
    pub unsafe fn IRCompilerSetRayTracingPipelineConfiguration(
        &self,
        compiler: *mut IRCompiler,
        configuration: *const IRRayTracingPipelineConfiguration,
    ) {
        (self.IRCompilerSetRayTracingPipelineConfiguration)(compiler, configuration)
    }
    ...
    #[doc = " Set fragment shader output sample mask.\n @param compiler compiler to configure.\n @param sampleMask bitmask to inform which samples get updated in active render targets. Defaults to 0xffffffff to update all samples\n This parameter is reset after each compilation."]
    pub unsafe fn IRCompilerSetSampleMask(&self, compiler: *mut IRCompiler, sampleMask: u32) {
        (self.IRCompilerSetSampleMask)(compiler, sampleMask)
    }
